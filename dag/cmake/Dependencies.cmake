...
list(APPEND DAG_LINKER_LIBS Boost_LIBRARIES)
...
# ---[ Google-gflags
#set(gflags_DIR oss/gflags/lib/cmake/gflags)
#find_package(gflags)
#include_directories (${gflags_INCLUDE_DIR})
#list(APPEND Dag_LINKER_LIBS gflags_LIBRARIES)
#message (STATUS "gflags_INCLUDE_DIR: ${gflags_INCLUDE_DIR}")
#message (STATUS "gflags_LIBRARIES: ${gflags_LIBRARIES}")
get_filename_component (gflags_INSTALL oss/gflags ABSOLUTE)
set(GFLAGS_INCLUDE_DIR ${gflags_INSTALL}/include)
set(GFLAGS_LIBRARIES_DIR ${gflags_INSTALL}/lib)
...
# ---[ Google-glog
get_filename_component (glog_INSTALL oss/glog ABSOLUTE)
set(GLOG_INCLUDE_DIR ${glog_INSTALL}/include)
set(GLOG_LIBRARIES_DIR ${glog_INSTALL}/lib)
set(GLOG_LIBRARIES glog)
include_directories (${GLOG_INCLUDE_DIR})
link_directories(${GLOG_LIBRARIES_DIR})
list(APPEND DAG_LINKER_LIBS GLOG_LIBRARIES)
