...
list(APPEND Dag_INCLUDE_DIRS PUBLIC ${PROTOBUF_INCLUDE_DIR})
list(APPEND Dag_LINKER_LIBS PUBLIC ${PROTOBUF_LIBRARIES})
...
if(PROTOBUF_FOUND)
  ...
  dag_parse_header(${PROTOBUF_INCLUDE_DIR}/google/protobuf/stubs/common.h VERION_LINE GOOGLE_PROTOBUF_VERSION)
...
file (MAKE_DIRECTORY ${proto_gen_folder})
...
# Usage:
#   dag_protobuf_generate_cpp_py(<output_dir> <srcs_var> <hdrs_var> <python_var> <proto_files>)
function(dag_protobuf_generate_cpp_py output_dir srcs_var hdrs_var python_var)
  if(NOT ARGN)
    message(SEND_ERROR "Error: dag_protobuf_generate_cpp_py() called without any proto files")
    return()
  endif()
  ...
  if(PROTOBUF_GENERATE_CPP_APPEND_PATH)
    ...
    foreach(fil ${ARGN})
      ...
      if(${_contains_already} EQUAL -1)
        list(APPEND _protoc_include ${abs_path})
      endif()
      message (STATUS "abs_fil: ${abs_fil}")
      message (STATUS "abs_path: ${abs_path}")
    endforeach()
  else()
    set(_protoc_include ${CMAKE_CURRENT_SOURCE_DIR})
  endif()
