//reference:
//[tinvaan/qlibrary-example](https://github.com/tinvaan/qlibrary-example)
//[Qt 之在运行时加载共享库](https://blog.csdn.net/liang19890820/article/details/77372826)
#include <string>
#include <iostream>
...
int main(int argc, char *argv[])
{
	...
	std::cout << "Operation ('add', 'sub', 'mul', 'div', 'avg') : ";
	std::cin >> choice;
